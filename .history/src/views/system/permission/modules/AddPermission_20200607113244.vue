<template>
  <a-modal :width="$enum('model.width')" :visible="visible" title="添加菜单" @cancel="cancel()">
    <a-form :form="form">
      <a-row :gutter="gutter">
        <a-col v-bind="col2">
          <a-form-item label="父级菜单">
            <a-input v-model="selectNode[0].title" disabled></a-input>
          </a-form-item>
        </a-col>
        <a-col v-bind="col2">
        ...
        <a-col v-bind="col2">
          <a-form-item label="菜单url">
            <a-input
              v-decorator="['permissionUrl']"></a-input>
          </a-form-item>
        </a-col>
        <a-col v-bind="col2">
          <a-form-item label="菜单权限">
            <a-input
              v-decorator="['permission']"></a-input>
          </a-form-item>
        </a-col>
        <a-col v-bind="col2">
          <a-form-item label="菜单组件">
            <a-input
              v-decorator="['component']"></a-input>
          </a-form-item>
        </a-col>
        <a-col v-bind="col2">
        ...
        <a-col v-bind="col2">
          <a-form-item label="菜单图标">
            <a-input
              v-decorator="['permissionIcon']"></a-input>
          </a-form-item>
        </a-col>
        <a-col v-bind="col2">
