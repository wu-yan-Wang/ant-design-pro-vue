    ...
    treeSelect (e, node) {
      ...
      if (e.length > 0) {
        ...
        getOneById({ id: this.selectId }).then(res => {
          ...
          this.form.setFieldsValue({ permissionCode:this.formData.permissionCode,
          ...
          permissionUrl:this.formData.permissionUrl,  redirect:this.formData.redirect,
          status:this.formData.status,
            component:this.formData.component,
          displayOrder:this.formData.status, })
