  ...
  methods: {
    editRole (record) {
      ...
      getOne(record).then((res) => {
        ...
        debugger
        this.form.setFields({ roleCode: this.data.roleCode, roleName: this.data.roleName, status: this.data.status, displayOrder: this.data.displayOrder })
      })
    },
    cancel () {
      this.visible = false
