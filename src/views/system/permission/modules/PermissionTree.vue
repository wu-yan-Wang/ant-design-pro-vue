            ...
            <a-row :gutter="gutter">
              ...
              <a-col v-bind="col2">
                <a-form-item label="重定向的路径">
                  <a-input v-decorator="['redirect', { initialValue: '' }]"></a-input>
                </a-form-item>
              </a-col>
              <a-col v-bind="col2">
                <a-form-item label="菜单图标">
                  <a-input
                    v-decorator="['permissionIcon', { initialValue: '' }]"
                    disabled
                  >
                    <template #addonAfter>
                      <a-icon
                        :type="iconType"
                        @click="$refs.previewIcons.previewIcon()"
                      ></a-icon>
                    </template>
                  </a-input>
                </a-form-item>
              ...
              <a-col v-bind="col2">
                <a-form-item label="排序">
                  <a-input
                    ...
                    v-decorator="[
                      'displayOrder',
                      { initialValue: '', rules: [{ required: true, message: '请输入排序' }] }
                    ]"
                  ></a-input>
                </a-form-item>
              </a-col>
  ...
  methods: {
    ...
    deletePermission () {
      ...
      this.$confirm({
        ...
        onOk: () => {
          this.loading = true
          deletePermission({ id: this.selectId })
            .then(() => {
              this.loadTreeData()
